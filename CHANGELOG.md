...
- 5 named engines — M1 Cousot Interval Propagation, M2 Falleri Structural Diff, M5 Bounded Subprocess Dry-Run, M6 Bayesian Per-Developer Preference, M7 Zheng Pairwise Rubric — full derivations in [docs/architecture/lich-architecture.md](docs/architecture/lich-architecture.md).
